...
<button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#newActorModal">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="">
          <div class="mb-3">
            <label for="aFname" class="form-label">First Name</label>
            <input type="text" class="form-control" id="aFname" name="aFname">
          </div>
          <div class="mb-3">
            <label for="aLname" class="form-label">Last Name</label>
            <input type="text" class="form-control" id="aLname" name="aLname">
          </div>
          <div class="mb-3">
            <label for="aNum" class="form-label">Phone Number</label>
