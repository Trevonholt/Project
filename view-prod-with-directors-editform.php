...
<button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#editMovieModal<?php echo $director['movie_id']; ?>">
...
<!-- Modal -->
<div class="modal fade" id="editMovieModal<?php echo $director['movie_id']; ?>" tabindex="-1" aria-labelledby="editMovieModalLabel<?php echo $director['movie_id']; ?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editMovieModalLabel<?php echo $director['movie_id']; ?>">Edit Movie</h1>
      ...
      <div class="modal-body">
        <form method="post" action="">
          ...
          <div class="mb-3">
            <label for="prod_id<?php echo $director['movie_id']; ?>" class="form-label">Production Company</label>
            <input type="text" class="form-control" id="prod_id<?php echo $director['movie_id']; ?>" name="prod_id" value="<?php echo $director['prod_id']; ?>">
          </div>
          <div class="mb-3">
